  ...
  return (
    <SectionWrapper>
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mx-auto">
        ...
        >
            <div className="w-24 h-24 rounded-full bg-cardBg border-4 border-darkBg outline outline-1 outline-gray-700 flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300">
                <Camera className="w-10 h-10 text-white" />
            </div>
            <div className="bg-cardBg p-6 rounded-2xl border border-white/5 w-full group-hover:border-white/20 transition-colors">
        ...
        <motion.div 
            ...
            className="relative z-10 flex flex-col items-center text-center group"
        >
             <div className="w-24 h-24 rounded-full bg-electricBlue border-4 border-darkBg outline outline-1 outline-electricBlue flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(41,121,255,0.4)] group-hover:scale-110 transition-transform duration-300">
